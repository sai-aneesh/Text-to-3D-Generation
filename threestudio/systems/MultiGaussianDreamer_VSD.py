...
class MultiGaussianDreamer(BaseLift3DSystem):
    ...
    def on_test_epoch_end(self):
        ...
        pc_save_path = self.get_save_path(f"point_cloud/iteration_7000/point_cloud.ply")
        self.gaussian.save_ply(pc_save_path)
        ...
        self.save_camera_params(self.camera_params)
