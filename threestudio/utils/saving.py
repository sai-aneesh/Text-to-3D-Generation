...
class SaverMixin:
    ...
    def get_save_path(self, filename):
        output_dir = os.path.join(os.getcwd(), 'gd_output')  
    ...
    def save_camera_params(self, camera_params):
        save_path = self.get_save_path('cameras.json')
        with open(save_path, 'w') as f:
            json.dump(camera_params, f, separators=(',', ':'))        
